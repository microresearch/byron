...
static void leaveBootloader()
{
    ...
    startBootloader = 0x00000000;      // Bootloader clear from application
...
//    GICR = _BV(IVCE); // from application bootloader
//    GICR = 0x00;
    nullVector();
}
...
#endif
        }while(bootLoaderCondition() || (startBootloader == 0x55AA1177) || (pgm_read_byte_near(0x0000) == 0xFF));  /* main event loop */
    }
    leaveBootloader();
}
