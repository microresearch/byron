/* Name: main.c // modified for xxxxx-hid board
 * Project: HID-Test
...
uchar	i, j;
    ...
    PORTB = 0x3f;   /* activate all pull-ups */
    DDRB = 0;       /* all pins input */
    PORTC = 0xff;   /* activate all pull-ups */
    DDRC = 0;       /* all pins input */

    PORTD = 0xe3;// was 0x03  /* pullups except usb */
    DDRD = 0xff; //shld be 0x18; was 0xff     /* all pins input except USB (-> USB reset) */
    	j = 0;
	...
	//		    DDRD = 0x00;    /* 0000 0010 bin: remove USB reset condition */
		DDRD = ~(USBMASK + 0x04);/*?? c7 or 04? all outputs except USB data and PD0/1/2INT*/
